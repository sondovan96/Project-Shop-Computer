				...
				<div class="col-md-9">
										...
										<div class="overflow-h margin-bottom-5">
											...
											<a
												href="${pageContext.request.contextPath }/product/detail?id=${p.id}"><button
													type="button" class="btn-u btn-u-sea-shop">Thêm
					...
					<div class="text-center">
						<ul class="pagination pagination-v2">
							<li><a
								href="${pageContext.request.contextPath }/product/list?trang=1"><i
									class="fa fa-angle-left"></i></a></li>
							<li><a
								href="${pageContext.request.contextPath }/product/list?trang=${trang==1?1:trang-1}"></a></li>
							<c:forEach begin="1" end="${tongSoTrang}" var="i">
								<li><a href="${pageContext.request.contextPath }/product/list?trang=${i}"> ${i}</a></li>
							</c:forEach>
							<li><a
								href="${pageContext.request.contextPath }/product/list?trang=${trang==tongSoTrang?tongSoTrang:trang+1}"></a></li>
							<li><a
								href="${pageContext.request.contextPath }/product/list?trang=${tongSoTrang}"><i
